// Graphic.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        double a[] = { 11,0,80,5,75,17,80,20,60,15,55,0,55,0,
                       20,10,40,20,40,10,20,0,20 };
